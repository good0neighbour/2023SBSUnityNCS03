...
public class CBrave : MonoBehaviour
{
    ...
    {
        Debug.Log("CBrave.DoMoveLeft");

        float tSpeedScalar = 1.0f;
        Vector3 tVelocity = new Vector3(-1.0f, 0.0f, 0.0f) * tSpeedScalar;
        //속도는 한 칸씩, 좌표기준은 월드 좌표계, 불연속적인 이동
        this.transform.Translate(tVelocity, Space.World);
    ...
    public void DoMoveRight()
    {
        ...
        {
            this.transform.position = new Vector3(1.0f, this.transform.position.y, this.transform.position.z);
        }
    }
}
