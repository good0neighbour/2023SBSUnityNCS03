...
public:
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		{
			//투영변환 행렬 적용
			MultiplyMatrixVector(tMeshRotate.tris[ti].p[0], tMeshProj.tris[ti].p[0], tMatProj);
			MultiplyMatrixVector(tMeshRotate.tris[ti].p[1], tMeshProj.tris[ti].p[1], tMatProj);
			MultiplyMatrixVector(tMeshRotate.tris[ti].p[2], tMeshProj.tris[ti].p[2], tMatProj);
